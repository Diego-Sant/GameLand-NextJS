    ...
    <MainLayout>
        ...
        <h2 className='font-bold mb-2'>Categorias</h2>
            ...
            <div className='flex-[3]'>
                {poster.map((item) => (
                    <Link href="/produto/7" key={item.id} className='md:flex justify-center items-center hidden cursor-pointer hover:brightness-95'><img className='bg-cover mb-[50px] xl:max-w-[880px] xl:min-w-[880px] 2xl:max-w-[1100px] 2xl:min-w-[1100px] 3xl:max-w-[1300px] 3xl:min-w-[1300px]' src={item.img} alt={item.title} /></Link>
                ))}
                <h1 className='flex items-center justify-center mb-5 text-3xl font-bold'>Mais vendidos</h1>
